...
@app.route('/page/<nickname>/<pagename>')
def page(nickname, pagename):
    user = User.query.filter_by(nickname = nickname).first()
    if user == None:
        flash('User ' + nickname + ' not found.')
        return redirect(url_for('index'))

    #user_page = user.user_page().filter_by(page_title = pagename).first()
    user_page = user.user_page(pagename)
